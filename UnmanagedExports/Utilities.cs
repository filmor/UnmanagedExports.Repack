...
// Type: UnmanagedExports.Utilities
...
namespace UnmanagedExports
{
  ...
  {
    public static readonly string DllExportAttributeAssemblyName = "UnmanagedExports.Metadata";
    public static readonly string DllExportAttributeFullName = "UnmanagedExports.DllExportAttribute";
